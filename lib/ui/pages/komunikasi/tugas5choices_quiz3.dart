...
class Tugas5ChoicesQuiz3Kom extends StatefulWidget {
  @override
  _Tugas5ChoicesQuiz3KomState createState() => _Tugas5ChoicesQuiz3KomState();
}

class _Tugas5ChoicesQuiz3KomState extends State<Tugas5ChoicesQuiz3Kom> {
  ...
  final List<RadioGroupKom3> _programmingList = [
    RadioGroupKom3(index: 1, text: "PEMIMPIN"),
    RadioGroupKom3(index: 2, text: "TEMAN"),
    RadioGroupKom3(index: 3, text: "KAKAK"),
    // RadioGroup(
    //     index: 3,
...
class RadioGroupKom3 {
  final int index;
  final String text;
  RadioGroupKom3({this.index, this.text});
}
